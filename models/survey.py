...
class SurveyBase(SQLModel):
    ...
    is_public: bool = Field(default=True, description="Whether survey is publicly accessible")
...
class SurveyRead(SurveyBase):
    ...
    created_at: datetime
    updated_at: datetime
    questions_count: int | None = Field(default=0, description="Number of questions in survey")
